...
public:
  ...
  {
    return std::forward<decltype(self)>(self).m_repr.work_directory;
  }

  [[nodiscard]] inline constexpr auto
  primary_output(this auto&& self) noexcept -> auto&&
  {
    return std::forward<decltype(self)>(self).m_repr.primary_output;
  }

  [[nodiscard]] inline constexpr auto
  outputs(this auto&& self) noexcept -> auto&&
  {
    return std::forward<decltype(self)>(self).m_repr.outputs;
  }

  [[nodiscard]] inline constexpr auto
  provides(this auto&& self) noexcept -> auto&&
  {
    return std::forward<decltype(self)>(self).m_repr.provides;
  }

  [[nodiscard]] inline constexpr auto
  requires_(this auto&& self) noexcept -> auto&&
  {
    return std::forward<decltype(self)>(self).m_repr.requires_;
  }
};
...
public:
  ...
  public:
    ...
    [[nodiscard]] auto format(std::string_view buffer) const noexcept
      -> std::string;
  };
  ...
  {
    return std::forward<decltype(self)>(self).m_repr.version;
  }

  [[nodiscard]] inline constexpr auto
  revision(this auto&& self) noexcept -> auto&&
  {
    return std::forward<decltype(self)>(self).m_repr.revision;
  }

  [[nodiscard]] inline constexpr auto
  rules(this auto&& self) noexcept -> auto&&
  {
    return std::forward<decltype(self)>(self).m_repr.rules;
  }
};
